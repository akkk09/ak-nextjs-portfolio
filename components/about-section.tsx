      ...
      <div className="container-xl">
        ...
        >
          <motion.div variants={itemVariants} className="flex flex-col space-y-16">
            ...
            <div>
              <p className="body-text text-foreground-secondary">
                Currently at{" "}
                <a
                  href="https://allen.in/referral?code=XZYUZO"
                  target="_blank"
                ...
                studying STEM and making dreams come true. Open to work if you're building something cool.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col space-y-16">
            ...
            <div>
              <p className="body-text text-foreground-secondary">
                When I'm not creating projects, I enjoy playing chess, reading, and learning new things. 
              </p>
            </div>
          </motion.div>
        </motion.div>
